...
5.  **Управление:** полная справка — в главном меню по кнопке «Управление».
    *   **Поворот:** `←`, `→` на месте; чем дольше удержание, тем круче поворот.
    *   **Прыжок:** удерживайте `Space` для замаха и отпустите для прыжка.
    *   **С телефона:** джойстик слева и кнопка прыжка справа.
