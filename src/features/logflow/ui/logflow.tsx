...
export const Logflow: FC = () => {
  ...
  return (
    <aside
      ...
      className='fixed top-0 right-0 pb-6 z-[10] w-[400px] max-h-[225px] rounded-bl-xl'>
      <h1 className='text-center text-2xl my-3'>{t('lobby_log_text')}</h1>
      <ul className='flex flex-col-reverse flex-nowrap gap-1 w-full h-[12vh] text-lg px-6 overflow-y-auto overflow-x-hidden'>
